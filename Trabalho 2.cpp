...
vector<double> jacobi(vector<vector<double>>& matrizA, vector<double>& vetorB, int maxIteracoes, double tolerancia) {
    int n = matrizA.size();
...
vector<double> gaussSeidel(vector<vector<double>>& matrizA, vector<double>& vetorB, int maxIteracoes, double tolerancia) {
    int n = matrizA.size();
    vector<double> x(n, 0.0);
...
int main() {
    int tamanho;
    cout << "Insira o tamanho da matriz (ex: 4 para uma matriz 4x4): ";
    cin >> tamanho;
    ...
    switch (opcao) {
        case 1:
            x = jacobi(matrizA, vetorB, maxIteracoes, tolerancia);
            break;
        case 2:
            x = gaussSeidel(matrizA, vetorB, maxIteracoes, tolerancia);
            break;
        case 3:
